...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem. accessibilityLabel = self.navigationItem.rightBarButtonItem.accessibilityIdentifier = @"Add Trivia Button";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.detailTextLabel.text = [[NSString alloc] initWithFormat:@"%ld",  currentTrivia.likes];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    FISAddTriviaTableViewController *destinationVC = segue.destinationViewController;
